...
<template>
    <div class="policy">
        ...
        <div class="policy-body">
            ...
            <ul>
                <li><p>The EU General Data Protection Regulation (GDPR)</p></li>
                <li><p>Data  Protection  Act  1998  and  the  new  Data  Protection  Act  which  will  enact  GDPR requirements</p></li>
                <li><p>Market Research Society’s (MRS) Code of Conduct</p></li>
            </ul>
            <p>This policy covers the personal data that CVR collects whenever you interact with us and the sections below will explain in more detail:</p>
            <ul>
                <li><p>the types of personal data we collect from you</p></li>
                <li><p>what types of third parties we receive personal data from</p></li>
                <li><p>how and why we process your personal data</p></li>
                <li><p>who we share your personal data with</p></li>
                <li><p>how long we retain your personal data</p></li>
                <li><p>your rights to withdraw your consent and your other personal data rights</p></li>
                <li><p>how to contact us and exercise your rights</p></li>
            </ul>
            <p><b>Personal data CVR collects from you</b><br>
            The information we collect can contain your personal opinions as well as personal information such as name, address, postcode, gender, occupation, age, date of birth, email address, telephone number etc. We may occasionally collect sensitive personal information such as political views. Where relevant to the research being undertaken, we may collect business contact information, such as company name, job title, and department. We collect all different types of personal data and sensitive data dependent on the research project, therefore the data is collected on the grounds of consent.</p>
            ...
            <ul>
                <li><p>you request or consent to share your identifying information and individual responses; or</p></li>
                <li><p>in the rare but possible circumstance that the information is subject to disclosure pursuant to judicial or other government subpoenas, warrants, orders or for similar legal or regulatory requirements.</p></li>
            </ul>
            <p>We also collect your personal information for one of the following purposes:</p>
            <ul>
                <li><p>to correspond with you after you have contacted us;</p></li>
            ...
            <p>We will not mislead you about the nature of the research or how the data will be used. The information on about the nature of the research and how the data will be used is normally placed on the invitation or the consent form (or informed as sent form).</p>
            <p>If you are invited to take part in research, it will be because:</p>
            <ul>
                <li><p>you have responded to a call-out to take part in a research project being conducted by CVR; or</p></li>
                <li><p>you were selected as you consented to, following a recent purchase from, or visit, one of the companies or organisations that has commissioned us; or</p></li>
                <li><p>you were selected because you are a service-user or service-provider to one of the companies or organisations that has commissioned us; or</p></li>
            ...
            <ul>
                ...
                <li><p>to <b>restrict</b> (i.e. stop any active) processing of your personal data</p></li>
                <li><p>to provide you with certain personal data in a <b>structured, machine-readable format</b> and to transmit that data to another organisation</p></li>
            </ul>
